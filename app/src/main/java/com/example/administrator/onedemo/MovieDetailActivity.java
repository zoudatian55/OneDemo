package com.example.administrator.onedemo;
...
import com.example.administrator.onedemo.adapter.CommentAdapter;
import com.example.administrator.onedemo.bean.MovieComment;
import com.example.administrator.onedemo.bean.MovieDatail;
import com.example.administrator.onedemo.bean.MovieDetailStory;
import com.example.administrator.onedemo.fragment.ListFragmentContent;
import com.example.administrator.onedemo.fragment.MoiveDicFragment;
import com.example.administrator.onedemo.fragment.PhotoFragment;
...
public class MovieDetailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //通过网络请求发送数据
        Deatil_first = Contant.BASE_URL + Contant.MOVIE_DETAIL + id + Contant.MOVIE_DETAIL_LIST;
        /**
         * 视频的网络请求
         */
        ...
        //分享那里有动画
        //故事详情的网络请求调用
        Deatil_STORY = Contant.BASE_URL + Contant.LIST_BASE_URL_LL + id + Contant.MOVIE_DETAIL_LIST_STORY;
        getNetWorkDataStory(Deatil_STORY);

        //评论的详情的网络请求
        Deatil_COMMENT= Contant.BASE_URL+ Contant.MOVIE_DETAIL_COMMENT+ id +"/0"+ Contant.MOVIE_DETAIL_COMMENT_LAST;
...
//                    startActivity(intent);
    ...
    private void getNetWorkDataComment(String deatil_comment) {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                commentlistview.setOnScrollListener(new AbsListView.OnScrollListener() {
                   ...
                   public void onScrollStateChanged(AbsListView view, int scrollState) {
                       if(scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && isLast){
                           getNetWorkDataComment(Contant.BASE_URL+ Contant.MOVIE_DETAIL_COMMENT+ id +"/"+ID+ Contant.MOVIE_DETAIL_COMMENT_LAST);
                ...
                adapter = new CommentAdapter(MovieDetailActivity.this, datas);
    ...
    private void initView() {
        ...
        backImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MovieDetailActivity.this,MainsActivity.class));
            }
        });
